...
const About = () => {
   return (
      <section className="bg-white pt-14 md:pt-28">
         <div className="container mx-auto px-6 text-font-black xl:px-0">
            ...
            <div className="flex items-center justify-center gap-8 text-font-black">
               {sosialMedia.map((item, index) => (
                  <Link key={index} href={item.href} className="rounded-full p-2 transition-all hover:bg-primary hover:text-white">
                     {item.icon}
                  </Link>
               ))}
            </div>
