    ...
    <section className="bg-white text-font-black">
      <div className="container mx-auto -mt-10 px-6 pb-14 md:mt-4 xl:mt-0 xl:px-0 xl:py-28">
        <div className="flex flex-col items-center gap-8 md:flex-row md:gap-16 xl:gap-[100px]">
          <Image src={VisiImg} alt="" className="w-full flex-1 overflow-hidden rounded-lg object-cover md:w-[600px]" />
          <div className="flex flex-1 flex-col gap-6 md:gap-8 xl:gap-[52px]">
            ...
            <p className="text-base leading-7 text-font-gray xl:text-xl xl:leading-9">"{desc}"</p>
          </div>
        </div>
      </div>
    </section>
