...
const Share: React.FC<ShareProps> = ({ url, meta }) => {
  return (
    <div className="mt-4 flex items-center gap-4 rounded-full px-2 py-1 shadow-lg md:mt-6 md:gap-5 md:px-4 md:py-2">
      <div className="cursor-pointer rounded-full bg-white p-1.5 text-sm hover:bg-slate-300 md:p-2 md:text-base">
        <FacebookShareButton quote={meta.title} hashtag={meta.category} url={url} className="flex">
          <FaFacebookF className="text-base md:text-lg" />
        </FacebookShareButton>
      </div>

      <div className="cursor-pointer rounded-full bg-white p-1.5 text-sm hover:bg-slate-300 md:p-2 md:text-base">
        <TwitterShareButton title={meta.title} hashtags={[meta.category as string]} url={url} className="flex">
          <FaTwitter className="text-base md:text-lg" />
        </TwitterShareButton>
      </div>

      <div className="cursor-pointer rounded-full bg-white p-1.5 text-sm hover:bg-slate-300 md:p-2 md:text-base">
        <WhatsappShareButton title={meta.title} url={url} className="flex">
