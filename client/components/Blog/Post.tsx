...
const Post: React.FC<PostProps> = ({ post }) => {
  ...
  return (
    <div className="mt-auto flex md:min-h-[400px] md:max-h-[400px] xl:max-h-[500px] xl:min-h-[500px] w-full flex-col gap-3 md:max-w-[336px] xl:max-w-[396px]">
      <div className="group relative h-44 w-full cursor-pointer overflow-hidden rounded-2xl md:h-48 xl:h-[240px]">
        ...
        <div className="absolute inset-0 flex cursor-default bg-slate-900/50 opacity-0 transition-all group-hover:opacity-100">
          <Link href={`/blogs/${postData.slug}`} className="m-auto flex h-12 w-12 cursor-pointer rounded-full bg-primary md:h-14 md:w-14 xl:h-[72px] xl:w-[72px]">
